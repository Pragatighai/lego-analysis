...
# Default base path for datasets folder - update if you moved it
BASE_DATA_PATH = Path(r"C:\Users\Sai\Desktop\extracted\datasets")

def print_menu():
    print("\nDATA3350 - Main Menu")
    print("1. Load datasets")
    print("2. Clean datasets")
    print("3. Run analysis (top products, average price)")
    print("4. Visualize data (plots)")
    print("5. Export cleaned CSVs")
    print("6. Quit")


def main():
    print("Starting DATA3350 local app")
    print(f"Default dataset path: {BASE_DATA_PATH}")
